...
\setbeamertemplate{frametitle}{\vspace{0.35em}\usebeamerfont{frametitle}\usebeamercolor[fg]{frametitle}\insertframetitle\par\vspace{-0.2em}\hrule height 1.2pt\vspace{0.2em}}
